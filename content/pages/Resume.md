---
title: "Resume"
date: 2025-09-25T12:14:19-07:00
draft: False
---
...
# Certifications & Training
    ...
    • Hack The Box Academy – Completed Information Security Foundations, Bug Bounty Hunter, and SOC Analyst Prerequisites paths; Labs – (app.hackthebox.com/profile/1068091)
    • Coursera – Applied Machine Learning in Python and Introduction to Data Science in Python
    • Forage – MasterCard (Phishing Email) and Telstra (SOC Alerts), 
    • Udemy – Python for Data Science, Linux, and SQL,
    •  eLearnSecurity – Penetration Testing Student, Splunk, 
    • Home lab/Cyber Range with Proxmox, ollama, VM’s with Windows, and Linux 
    • Hardware Security Tools: home made bad USB, Raspberry Pi Zero, and ESP32 , FlipperZero.

# Technical Skills and Tools

    • Nmap, Burp Suite, Metasploit, NetCat, Hydra, John the Ripper, Hashcat, SQLMap, Gobuster, Ffuf, Nikto, ZAP, OpenVAS, Nessus, tcpdump, Wireshark, Wazuh, Bloodhound, GDP, Ghidra, Vim, Tmux, Impacket, Subfinder,  ChatGPT, and Ollama
    • Windows, Windows Server, Linux, macOS, Proxmox, WSL2, VirtualBox, Gnome Boxes
    • Python3, Python2, SQL, Bash, C++, C, JavaScrip, PHP, HTML, CSS, XML, PowerShell, Java, Go, Rust, Intel x86 Assembly.
