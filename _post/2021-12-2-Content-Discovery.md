...
Take a look at the robots.txt file on the Acme IT Support website to see if they have anything they don't want to list: http://10.10.159.59/robots.txt
Answer the questions below
...
Take a look at the sitemap.xml file on the Acme IT Support website to see if there's any new content we haven't yet discovered: http://10.10.159.59/sitemap.xml
Answer the questions below
...
user@machine$ curl http://10.10.159.59 -v
*   Trying 10.10.159.59:80...
* TCP_NODELAY set
...
Looking at the page source of our Acme IT Support website (http://10.10.159.59), you'll see a comment at the end of every page with a page load time and also a link to the framework's website, which is https://static-labs.tryhackme.cloud/sites/thm-web-framework. Let's take a look at that website. Viewing the documentation page gives us the path of the framework's administration portal, which gives us a flag if viewed on the Acme IT Support website.
Answer the questions below
...
user@machine$ ffuf -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt -u http://10.10.159.59/FUZZ
...
user@machine$ dirb http://10.10.159.59/ /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt
...
user@machine$ gobuster dir --url http://10.10.159.59/ -w /usr/share/wordlists/SecLists/Discovery/Web-Content/common.txt
...
Created by tryhackme and adamtlangley

This is a free room, which means anyone can deploy virtual machines in the room (without being subscribed)! 15224 users are in here and this room is 125 days old.
