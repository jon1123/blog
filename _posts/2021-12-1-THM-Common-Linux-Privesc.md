...
A: new:$1$new$p7ptkEKU1HnaHpRtzNizS1:0:0:/root:/bin/bash
...
Created by PoloMints

Only subscribers can deploy virtual machines in this room! Go to your profile page to subscribe (if you have not already). 24518 users are in here and this room is 601 days old.
